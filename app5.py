...
def obtener_empleados():
    c.execute("SELECT Empleados.Nombre as Nombre, Departamentos.NombreDepartamento as Departamento FROM Empleados JOIN Departamentos ON Empleados.DepartamentoID = Departamentos.DepartamentoID")
    return c.fetchall()
